...
function FlightsSection({ trip, setBooked, go, preferences, notify }: any) {
  const [form, setForm] = useState<FlightSearchForm>(() => ({ origin: trip.origin.code || "BLR", destination: "BOM", departureDate: trip.startDate, returnDate: trip.endDate, travelers: 1, cabin: preferences.cabin || "ECONOMY" }));
  const [originText, setOriginText] = useState("BLR · Bengaluru");
  const [destinationText, setDestinationText] = useState("BOM · Mumbai");
